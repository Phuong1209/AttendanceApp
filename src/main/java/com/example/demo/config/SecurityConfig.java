...
//    private final String[] PUBLIC_URLS = {"/auth/token", "/auth/introspect","/auth/register","/", "/login", "/css/**", "/js/**"};
//    private final String[] PRIVATE_URLS = {"/user","worktime/checkin"};
//    @Bean
...
//        converter.setAuthoritiesClaimName("position"); // Make sure "positions" is the correct claim in your JWT.
